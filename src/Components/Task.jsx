...
import { mode, toggle } from "../redux/slices/editModeSlice.js";
				...
				<Reorder.Item className={wrapTask ? "task wrap" : "task"} as="div" value={task}>
					<div className="headerTask">
						...
						<div className="panel">
							...
							<input name={"inputTaskCheckbox"} checked={task.completed} className="checkbox" ref={checkbox}
										 onChange={() => editTodo(task)} type="checkbox" />
							<button onClick={() => edit()}
											id="btnEdit"><i className="bi bi-pencil-square"></i></button>
							<button id="btnDelete" onClick={() => deleteTodo(task._id)}><i
